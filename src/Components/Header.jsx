  ...
  return (
    <>
      <header className='flex justify-between items-center max-w-screen-2xl mx-auto p-4'>
        ...
        <div className='hidden mb:flex items-center gap-6'>
          <Search />
          <Registered />
        </div>
      ...
      <div className={`absolute ${show ? 'translate-x-0' : '-translate-x-full'} flex items-center justify-center w-full h-screen top-0 bg-slate-500 z-50 transition duration-1000 out-ease-in`}>
        <SideMenu />
